...
\title{MVCWalker: A Random Walk Model for Recommending the Most Valuable Collaborators through Injection of Academic Factors}

\author{Feng Xia, \IEEEmembership{Senior Member, IEEE,}
        XXX, XXX, XXXX, and XXX% <-this % stops a space
\IEEEcompsocitemizethanks{\IEEEcompsocthanksitem F. Xia, XXX, XXX, and XXX are with School of Software, Dalian University of Technology, Dalian 116620, China.\protect\\Email: f.xia@ieee.org.}
